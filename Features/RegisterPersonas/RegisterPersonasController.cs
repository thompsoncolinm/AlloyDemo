...
using Microsoft.AspNetCore.Mvc.Filters;  // Add this line
...
namespace AlloyDemo.Features.RegisterPersonas
{
    public class RegisterPersonasController : Controller
    {
        ...
        public static UserAndRoles[] Users = new[]
        {
            new UserAndRoles
            {
                UserName = "Alice", // a CMS Admin who more access rights
                Roles = new[] { accessToAdminView, marketersRole, newsEditorsRole }
            },
            new UserAndRoles
            {
